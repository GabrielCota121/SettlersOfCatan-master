...
public class BoardFactory {
    ...
    /** Tabuleiro com layout aleatório (uso local/offline). */
    public static Board createStandardBoard() {
        return createStandardBoard(new Random().nextLong());
    }

    /**
     * Tabuleiro determinístico a partir de uma seed. Servidor e clientes geram
     * EXATAMENTE o mesmo layout (recursos, números e portos) usando a mesma seed —
     * essencial para que todos vejam o mesmo mapa no multiplayer.
     */
    public static Board createStandardBoard(long seed) {
        ...
        assignRandomPorts(board, rng);

        return board;
    }

    private static void assignRandomPorts(Board board, Random rng) {
        ...
        Collections.shuffle(portsToAssign, rng);
        ...
        Collections.shuffle(coastalEdges, rng);
