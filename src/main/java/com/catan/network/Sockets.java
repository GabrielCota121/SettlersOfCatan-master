...
public class Sockets {
     ...
     */
    private static Map<Inet4Address, DatagramSocket> broadcastUdpSockets = new HashMap<>();// usar na hora de detectar as partidas. Buscará em múltiplas redes
    ...
    public static void addNewBroadcastSocket(Inet4Address ipLocal, Inet4Address ipBroadcast, int port) throws IOException {
        broadcastUdpSockets.put(ipLocal, createUdpSocket(ipBroadcast, port, true)); // para eu poder recuperar um socket de broadcast dado meu ip na rede local
    }
